...
const chartData = [
    ...
    { month: "July", desktop: 205, mobile: 140 },
    { month: "August", desktop: 214, mobile: 140 },
    { month: "September", desktop: 190, mobile: 140 },
    { month: "October", desktop: 150, mobile: 140 },
    { month: "November", desktop: 120, mobile: 140 },
    { month: "December", desktop: 180, mobile: 140 },
]
        ...
        <div className="rounded-[8px] p-[25px] border-[1px] border-[#E5E7EB] bg-white w-full shadow-md">
            ...
            <ChartContainer config={chartConfig} className="min-h-[200px] w-full mt-3">
                <BarChart accessibilityLayer data={chartData}>
                    ...
                    <Bar dataKey="desktop" fill="#CA00E5" radius={4} barSize={30} />
                </BarChart>
            </ChartContainer>
        </div>
    )
