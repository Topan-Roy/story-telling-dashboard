...
export default function CoinManagement() {
    ...
    const [showAddPackage, setShowAddPackage] = React.useState<boolean>(false)
    return (
        <section className="flex items-start justify-center bg-[#F9F9F9] relative">
            ...
            <div className='w-full relative'>
                ...
                <div className='mt-6    px-6'>
                    <h1 className='font-[700] text-[20.4px] leading-[32px] inter-font'>Coin Management</h1>
                </div>
                <div className='mt-6    px-6'>
                    <div className='flex items-center justify-start gap-6 border-b-[1px] border-[#E5E7EB] '>
                        <div className={`flex items-center justify-center gap-[10px] py-3 border-b-[2px] border-b-[#9458E8]`}>
                            <Link to={`/dashboard/coin-management-package`} className={`font-[700] text-[11.9px] leading-[20px] text-[#9458E8] inter-font cursor-pointer`}>Coin Packages</Link>
                        </div>
                        <div className={`flex items-center justify-center gap-[10px] py-3`}>
                            <Link to={`/dashboard/coin-management-analytics`} className={`font-[700] text-[11.9px] leading-[20px] text-[#6B7280] inter-font cursor-pointer`}>Analytics</Link>
                        </div>
                    </div>
                </div>
                <div className='mt-6 px-6'>
                    <div className='flex items-center justify-between'>
                        <h1 className='text-[#1F2937] text-[15.3px] leading-[28px] font-[600]'>Coin Packages</h1>
                        <div onClick={() => setShowAddPackage(true)} className='flex items-center justify-center py-[8px] px-[16px] gap-2 cursor-pointer rounded-[6px]' style={{ background: "linear-gradient(to right, #9458E8, #CA00E5)" }}>
                ...
                {showAddPackage ? <AddPackage setShowAddPackage={setShowAddPackage} /> : <></>}
                <div className='mt-6 px-6'>
