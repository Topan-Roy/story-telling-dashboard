    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-lg font-semibold text-[#000000]">Items Avatars</h2>
                <button
            ...
            {loading ? (
                <p className="text-center mb-10 text-gray-500">Loading...</p> // 🔥 Loading UI
            ) : (
            ...
            <AddAvatarModal
                ...
                onSave={(data) => console.log("New item:", data)}
            />
        </div>
    );
}
